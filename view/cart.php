                ...
                <tbody class="align-middle">
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="align-middle total-item " data-cart-detail-id="<?= $item['id'] ?>"><?= number_format($total_item_price) ?> </td>
                                <td class="align-middle">
        ...
        <div class="col-lg-4 ">
            ...
            <div class="card border-secondary mb-5">
                ...
                <div class="card-footer border-secondary bg-transparent">
                    ...
                    <a href="index.php?pg=checkout" class="btn btn-block btn-primary my-3 py-3">Thanh toán</a>
                </div>
            </div>
        </div>
    </div>
